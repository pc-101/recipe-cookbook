  ...
  return (
    <>
      ...
      >
        ...
        {error && (
          <div className="rounded-md border border-rose-300 bg-rose-50 p-3 text-sm text-rose-700 dark:border-rose-900 dark:bg-rose-900/30 dark:text-rose-300">
            {error}
          </div>
        )}
        ...
        {!loading && results.length === 0 && debounced && (
          <div className="text-sm text-slate-500">
            No recipes. Try a different query or filters.
          </div>
        )}
